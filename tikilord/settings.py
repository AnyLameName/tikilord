"""
Django settings for tikilord project.
...
SECRET_KEY = 'django-insecure-awhy4+cmz)c=t&(!=k_8y2eg!01)7@_n=0+7a0bh9@xqih7&ez'
...
WSGI_APPLICATION = 'tikilord.wsgi.application'
